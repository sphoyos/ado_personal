program define ht_tabla_pairtest_eng
...
if  `ordendif'==12 {
   gen `var3'= `var1'-`var2'
   local var3_lab="Difference `varlab1'-`varlab2'"
}
else if  `ordendif'==21 {
   gen `var3'= `var2'-`var1'
   local var3_lab="Difference `varlab2'-`varlab1'"
}
else  {
    display as err /*
        */ "ordendif ha de valer 12 or 21"
        exit 198
}							
...
forvalues  j=1(1)3 {
 ...
 local variable: di "N <p> Mean (sd) </p>    		


       if "`ci'"!="" {
			     local variable: di  "N <p> Mean  [IC 95%]  </p> " 		 
				}
 ...
 * "
 ...
 htput <TH VALIGN=CENTER ALIGN=CENTER   > `variable' </TH>
  ...
  forvalues  j=1(1)3 {
   ...
   if `haytest_ttest'==1 {
       htput <TH VALIGN=CENTER  > <p> p-value </p> <p> Paired  T-test  </p> </TH>
   }
  
  
   if `haytest_sign'==1 {
       htput <TH VALIGN=CENTER  > <p> p-value </p> <p> Sign Test </p> </TH>
   }
   
    if `haytest_signrank'==1 {
       htput <TH VALIGN=CENTER  > <p> p-value </p> <p> Wilcoxon Sign-rank Test </p> </TH>
   }
 htput </TR>
