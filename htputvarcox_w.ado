...
program define htputvarcox_w
version 9.1
syntax [if] [in] [iw] , reg(string) [dep(varname)] indep(string) [rr(string)] [trans(string)] [per(string)] [multi] [PERMute(integer 0)] [color] [options(string)] [adjust(string)] [note(string)]
...
file open prg_code using `_mymodel'.ado, write replace
	...
	file write prg_code "syntax [if] [in] [iw], cmd(string) [dep(string)] indep(string) [opt(string)] [adj(string)]" _n
